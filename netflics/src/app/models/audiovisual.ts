export class audiovisual{
    ...
    public percentajePersonalized : number = 95;
    public gender : string[] = ['genero1', 'genero2'];
    public cast : string[] = ['alguien', 'alguien 2'];
    public title : string[] = ["¿Es pastel?, Episodio 1"];
    public description : string[] = ["esto es una descripcion"];
    public classification : string = "+16";
